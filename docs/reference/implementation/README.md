...
| `AGENT-WORKSPACE-005` | Gate 2 真实 WorkBuddy 在 DCR callback 校验处 blocked，未进入 OAuth；Preview、fixture、旧 clients 与客户端配置已恢复或清理。Product amendment B 等待产品代码授权，provider、migration 与 Production 未触碰 | [`intake`](agent-workspace-005-intake-2026-08-01.md)、[`client compatibility`](agent-workspace-005-client-compatibility-2026-08-01.md)、[`Preview runtime`](agent-workspace-005-preview-runtime-2026-08-01.md) |
