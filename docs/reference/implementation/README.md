...
| `AGENT-WORKSPACE-005` | Gate 4 独立复审 PASS；Gate 5 Recovery amendment D 已冻结，只适配 backup restore assertion，尚未执行 Production migration/release | [`intake`](agent-workspace-005-intake-2026-08-01.md)、[`client compatibility`](agent-workspace-005-client-compatibility-2026-08-01.md)、[`Preview runtime`](agent-workspace-005-preview-runtime-2026-08-01.md)、[`operational readiness`](agent-workspace-005-operational-readiness-2026-08-01.md)、[`independent review`](agent-workspace-005-independent-review-2026-08-01.md) |
