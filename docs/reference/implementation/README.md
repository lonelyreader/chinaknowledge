...
| `AGENT-WORKSPACE-005` | phase-release intake、Gate 1 只读预检与最小 adapter 下载修复已通过 Local 验证和独立复审；WorkBuddy/Cursor 配置、callback、Preview 基线和精确清理 locator 已固定；尚未创建项目 OAuth、部署或修改 provider | [`intake`](agent-workspace-005-intake-2026-08-01.md)、[`client compatibility`](agent-workspace-005-client-compatibility-2026-08-01.md) |
