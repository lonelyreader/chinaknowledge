...
| `AGENT-WORKSPACE-005` | Gate 3 独立复审 PASS；当前执行 Gate 4 Preview release rehearsal，尚未执行 migration 或 Production release | [`intake`](agent-workspace-005-intake-2026-08-01.md)、[`client compatibility`](agent-workspace-005-client-compatibility-2026-08-01.md)、[`Preview runtime`](agent-workspace-005-preview-runtime-2026-08-01.md)、[`operational readiness`](agent-workspace-005-operational-readiness-2026-08-01.md)、[`independent review`](agent-workspace-005-independent-review-2026-08-01.md) |
