...
| `AGENT-WORKSPACE-005` | phase-release intake 与 Gate 1 只读预检完成；已固定 WorkBuddy/Cursor 配置、callback、Preview 基线和精确清理 locator，发现 adapter 下载需最小修正；尚未创建项目 OAuth、部署或修改 provider | [`intake`](agent-workspace-005-intake-2026-08-01.md)、[`client compatibility`](agent-workspace-005-client-compatibility-2026-08-01.md) |
