...
| `AGENT-WORKSPACE-005` | Gate 2 已证明 WorkBuddy OAuth/MCP 私有工作流、re-auth/revoke 与 Cursor callback/discovery；prepare confirmation 和 Cursor capability call 仍 open。Preview 已恢复，provider、migration 与 Production 未触碰 | [`intake`](agent-workspace-005-intake-2026-08-01.md)、[`client compatibility`](agent-workspace-005-client-compatibility-2026-08-01.md)、[`Preview runtime`](agent-workspace-005-preview-runtime-2026-08-01.md)、[`independent review`](agent-workspace-005-independent-review-2026-08-01.md) |
