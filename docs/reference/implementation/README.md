...
| `PUB-CURATION-001` | 已完成当前实现与新产品逻辑的架构审计；公共视觉可保留，CMS 状态、权限、read model 与路由需要重构 | [`member publishing and curation audit`](member-publishing-curation-architecture-audit-2026-07-28.md) |
