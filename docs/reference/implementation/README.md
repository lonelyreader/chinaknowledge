...
| `AGENT-WORKSPACE-005` | phase-release intake 已收窄首个真实客户端门，记录当前版本、server protection gap、migration 与分立授权；尚未登录客户端、部署或修改 provider | [`intake`](agent-workspace-005-intake-2026-08-01.md) |
