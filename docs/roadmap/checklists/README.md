...
当前唯一 implementation active checklist 是 [`AGENT-WORKSPACE-005`](agent-workspace-compatibility-release.md)：Gate 3 独立复审 `PASS`，当前执行 Gate 4 Preview release rehearsal。TRAE 不在范围，规则不扩大业务能力、schema 或依赖。
