...
const activityLabels: Record<string, string> = {
  ...
  my_profile_get: "Profile viewed",
  my_profile_save: "Profile saved",
  my_links_save: "Profile links saved",
  my_profile_prepare_publication: "Profile visibility checked",
  my_profile_commit_publication: "Profile visibility changed",
  my_articles_list: "Articles viewed",
  my_media_list: "Images viewed",
  article_get_working_copy: "Article opened",
  article_create_draft: "Draft created",
  article_create_translation_draft: "Translation draft created",
  article_save_draft: "Draft saved",
  media_upload: "Image uploaded",
  article_set_cover: "Cover changed",
